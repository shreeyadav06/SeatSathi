...
export const LandingPage: React.FC<LandingPageProps & { onNoteClick?: () => void }> = ({ 
  ...
  return (
    <div className={`min-h-screen max-h-screen flex flex-col font-sans selection:bg-blue-500/30 overflow-y-auto custom-scrollbar ${theme === 'dark' ? 'bg-black text-[#F2F2F7]' : 'bg-[#F2F2F7] text-[#1C1C1E]'}`}>
      ...
      <nav className={`flex items-center justify-between px-4 sm:px-6 py-4 max-w-7xl mx-auto w-full sticky top-0 z-50 transition-colors duration-300 ${theme === 'light' ? 'bg-[#F2F2F7]/70 backdrop-blur-xl border-b border-[#E5E5EA]' : 'bg-black/70 backdrop-blur-xl border-b border-[#2C2C2E]'}`}>
        <div className="flex items-center gap-2">
          <div className="w-8 h-8 rounded-lg bg-[#007AFF] flex items-center justify-center text-white font-bold text-lg shadow-sm">S</div>
          <span className={`text-xl font-semibold tracking-tight ${theme === 'dark' ? 'text-white' : 'text-[#1C1C1E]'}`}>Seat<span className="text-[#007AFF]">Sathi</span></span>
        </div>
          ...
          {user ? (
            <div className="flex items-center gap-3">
              <div className="flex items-center gap-2">
                {user.photoURL ? (
                  ...
                  <div className="w-8 h-8 rounded-full bg-[#007AFF]/10 flex items-center justify-center text-[#007AFF] font-medium text-sm">
              ...
              <motion.button
                ...
                transition={{ type: "spring", bounce: 0, duration: 0.4 }}
                onClick={onLogout}
                className={`px-3 py-1.5 text-sm rounded-lg transition-colors ${theme === 'dark' ? 'text-[#8E8E93] hover:text-white bg-[#1C1C1E] hover:bg-[#2C2C2E]' : 'text-[#8E8E93] hover:text-[#1C1C1E] bg-[#E5E5EA] hover:bg-[#D1D1D6]'}`}
              >
                Logout
              </motion.button>
            </div>
            ...
            <div className="flex items-center gap-2">
              <motion.button
                ...
                className={`px-4 py-2 text-sm font-medium rounded-full transition-colors flex items-center gap-2 ${theme === 'dark' ? 'text-white bg-[#2C2C2E] hover:bg-[#3A3A3C]' : 'text-[#1C1C1E] bg-[#E5E5EA] hover:bg-[#D1D1D6]'}`}
              >
              ...
              <motion.button
                ...
                className="px-4 py-2 text-sm font-medium rounded-full flex items-center gap-2 bg-[#007AFF] text-white hover:bg-[#007AFF]/90"
              >
                <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
